...
public class FakeCoins {
     ...
     * 
     * @param left index to start the search.
     * @param right index to end the search.
     ...
     * 
     * @param left index to start weighting.
     * @param right index to end weighting.
