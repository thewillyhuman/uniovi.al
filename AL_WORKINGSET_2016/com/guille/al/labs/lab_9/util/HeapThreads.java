...
public class HeapThreads {
    ...
    private ConcurrentHashMap<UUID, Node> usedNodes; // To compose the solution
						     // and to know what nodes
						     // have been treated
     ...
     * 
     * @param node
     *            Node from which we want to extract the path to the root node
	...
	if (!nodeRepeated(node)) { // To not repeat used nodes and avoid
